...
def test_the_campaign_run_wires_the_beat_into_the_loop_and_accumulates():
    ...
    # equipment (tank/gun, its REAL per-type Tonnage, cheapest-first election), the [20.63] two-Game-Turn
    # lead. It is a charged flow-in where the Commonwealth's is free (20.75).
    ...
    for e in axis_events:
        ...
        if p["type"] == "infantry":
            ...
            assert p["tons_charged"] > 0                    # equipment: real per-type Tonnage (>0)
