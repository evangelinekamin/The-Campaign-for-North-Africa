...
HOLD_DIRECTIVE = (
    ...
    "supply_on_hex true has a stocked dump standing on it -- a combat unit there draws at distance "
    "0 and is the cheapest ground you can bank, so never leave one empty. Then advance only as far "
    "as your supply follows: a dump can only move onto a hex your own combat units hold (32.33), "
    "so a "
